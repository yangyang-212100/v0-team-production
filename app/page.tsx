...
import { Bell, Briefcase, Clock, MessageSquare, Mic, Plus, Users, Building2, Send, BarChart3, CheckCircle2, Circle, AlertCircle, Eye, Edit, ExternalLink, AlarmClock, Moon, Sun, TrendingUp, Calendar, Target, FileText, Settings, Search, LogOut, User, ChevronDown, Trash2, MapPin, DollarSign } from 'lucide-react'
      ...
      <div className="px-4 py-6 pb-24 space-y-6">
        ...
        <div className="bg-[#F8FAFC]/95 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-[#E0E9F0] relative z-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <Search className="h-5 w-5 text-[#B4C2CD]" />
                        </div>
